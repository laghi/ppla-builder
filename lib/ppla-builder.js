...
PplaBuilder = {
    ...
    overwriteDefaults: function(newDefaults){
        var assignOnlyDefaults = _.partialRight(_.assign, function(defaultValue, sourceValue) {
            return defaultValue === undefined ? defaultValue : sourceValue;
        });
        assignOnlyDefaults(this.defaults, newDefaults);
        return this;
    },
    ...
    build: function () {
        ...
        console.log("Building label: " + finalLabel);
